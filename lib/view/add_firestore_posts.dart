...
class AddFirestorePosts extends StatelessWidget {
  const AddFirestorePosts({super.key, required this.id, required this.action});
  final String id;
  final String action;
  @override
  Widget build(BuildContext context) {

    final FirestoreController homeController = Get.find();
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                homeController.databaseRef.value.doc(id).set({
